...
if __name__ == '__main__':
    ...
    dataset_dict = {
        'RealSRx2': ['src/EAMamba/configs/test/sr/test-RealSRx2.yaml'],
        'RealSRx3': ['src/EAMamba/configs/test/sr/test-RealSRx3.yaml'],
        'RealSRx4': ['src/EAMamba/configs/test/sr/test-RealSRx4.yaml'],
        'SIDD': ['src/EAMamba/configs/test/denoise/test-SIDD.yaml'],
        'Denoise': ['src/EAMamba/configs/test/denoise/test-CBSD68-color-sig15.yaml',
                    'src/EAMamba/configs/test/denoise/test-Kodak24-color-sig15.yaml',
                    'src/EAMamba/configs/test/denoise/test-McMaster-color-sig15.yaml',
                    'src/EAMamba/configs/test/denoise/test-Urban100-color-sig15.yaml',
                    'src/EAMamba/configs/test/denoise/test-CBSD68-color-sig25.yaml', 
                    'src/EAMamba/configs/test/denoise/test-Kodak24-color-sig25.yaml',
                    'src/EAMamba/configs/test/denoise/test-McMaster-color-sig25.yaml',
                    'src/EAMamba/configs/test/denoise/test-Urban100-color-sig25.yaml',
                    'src/EAMamba/configs/test/denoise/test-CBSD68-color-sig50.yaml',
                    'src/EAMamba/configs/test/denoise/test-Kodak24-color-sig50.yaml',
                    'src/EAMamba/configs/test/denoise/test-McMaster-color-sig50.yaml',
                    'src/EAMamba/configs/test/denoise/test-Urban100-color-sig50.yaml'],
        'Denoise-sig15': ['src/EAMamba/configs/test/denoise/test-CBSD68-color-sig15.yaml',
                          'src/EAMamba/configs/test/denoise/test-Kodak24-color-sig15.yaml',
                          'src/EAMamba/configs/test/denoise/test-McMaster-color-sig15.yaml',
                          'src/EAMamba/configs/test/denoise/test-Urban100-color-sig15.yaml'],
        'Denoise-sig25': ['src/EAMamba/configs/test/denoise/test-CBSD68-color-sig25.yaml',
                          'src/EAMamba/configs/test/denoise/test-Kodak24-color-sig25.yaml',
                          'src/EAMamba/configs/test/denoise/test-McMaster-color-sig25.yaml',
                          'src/EAMamba/configs/test/denoise/test-Urban100-color-sig25.yaml'],
        'Denoise-sig50': ['src/EAMamba/configs/test/denoise/test-CBSD68-color-sig50.yaml',
                          'src/EAMamba/configs/test/denoise/test-Kodak24-color-sig50.yaml',
                          'src/EAMamba/configs/test/denoise/test-McMaster-color-sig50.yaml',
                          'src/EAMamba/configs/test/denoise/test-Urban100-color-sig50.yaml'],
        'Motion_Deblur': ['src/EAMamba/configs/test/deblur/test-GoPro.yaml',
                          'src/EAMamba/configs/test/deblur/test-HIDE.yaml'],
        'GoPro': ['src/EAMamba/configs/test/deblur/test-GoPro.yaml'],
        'HIDE' : ['src/EAMamba/configs/test/deblur/test-HIDE.yaml'],
        'RESIDE_ITS': ['src/EAMamba/configs/test/dehaze/test-RESIDE-ITS.yaml'],
        'RESIDE_OTS': ['src/EAMamba/configs/test/dehaze/test-RESIDE-OTS.yaml'], 
        'Derain': ['src/EAMamba/configs/test/derain/test-Rain100H.yaml',
                    'src/EAMamba/configs/test/derain/test-Rain100L.yaml',
                    'src/EAMamba/configs/test/derain/test-Test100.yaml',
                    'src/EAMamba/configs/test/derain/test-Test1200.yaml',
                    'src/EAMamba/configs/test/derain/test-Test2800.yaml'],
        'SRx2': ['src/EAMamba/configs/test/sr/test-ySet5x2.yaml',
                 'src/EAMamba/configs/test/sr/test-ySet14x2.yaml',
                 'src/EAMamba/configs/test/sr/test-yB100x2.yaml',
                 'src/EAMamba/configs/test/sr/test-yUrban100x2.yaml'],
        'SRx3': ['src/EAMamba/configs/test/sr/test-ySet5x3.yaml',
                 'src/EAMamba/configs/test/sr/test-ySet14x3.yaml',
                 'src/EAMamba/configs/test/sr/test-yB100x3.yaml',
                 'src/EAMamba/configs/test/sr/test-yUrban100x3.yaml'],
        'SRx4': ['src/EAMamba/configs/test/sr/test-ySet5x4.yaml',
                 'src/EAMamba/configs/test/sr/test-ySet14x4.yaml',
                 'src/EAMamba/configs/test/sr/test-yB100x4.yaml',
                 'src/EAMamba/configs/test/sr/test-yUrban100x4.yaml'],
        'DPDD': ['src/EAMamba/configs/test/deblur/test-DPDD-indoor.yaml',
                 'src/EAMamba/configs/test/deblur/test-DPDD-outdoor.yaml',
                 'src/EAMamba/configs/test/deblur/test-DPDD.yaml'],
    }
